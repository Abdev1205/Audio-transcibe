...
const AllFIleInfo = ({ fileData }) => {
  const router = useRouter();
  console.log(fileData)
  return (
    <div onClick={() => router.push(`/files/${fileData._id}`)} className=' flex justify-between  items-center  p-[1rem] w-[100%]  border-[1px] border-[#E4E7EC] bg-white  hover:border-primary cursor-pointer rounded-lg ' >
